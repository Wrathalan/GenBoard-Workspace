...
# Verification â€” 0.1.1 â€” 2026-09-13
...
The 500-image test uses distinct 512Ã—768 synthetic color images on a board at 22% zoom. During a 100-step native pointer pan, 268 measured animation-frame intervals had a **4.2 ms median and 12.6 ms 95th percentile**. These intervals meet the approximate 60 FPS interaction target in this fixture. See `benchmark.json` for the raw summary.
